<?php 
    ...
    if ($gst!=NULL) {
            ...
            $fechaGstFmt=$dttfmt->format($gst->fecha_gst);
            $dtt_fechaGst=date($gst->fecha_gst);
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td><input type="number" readonly name="id_gst"  id="gst_nombreusuario" value="<?=$gst->id_gst?>" ></td>
                    </tr>

                    <tr>
                        <th class="etiqueta">CODIGO:</th>
                        <td>
                            <select required name="gst_codigo" id="gst_codigo" value="<?=$gst->codigo_gst?>">
